...
HomeFix là hệ thống đặt lịch dịch vụ sửa chữa nhà cửa, bao gồm:
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=local\\SQLEXPRESS;Database=HomeServiceDB;Integrated Security=True;TrustServerCertificate=True;MultipleActiveResultSets=true"
  }
}
```
...
> **HomeFix v1.0** — ASP.NET Core 8.0 + Entity Framework Core + SQL Server Express
